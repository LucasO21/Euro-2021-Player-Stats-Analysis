---
title: "Euro 2021 Data Analysis"
author: "Writen by Lucas Okwudishu on 06/18/2021"
output:
    html_document:
        theme: flatly
        highlight: tango
...
### __Step 3: Scrape Tables for Participating Countries__
...
I took the following steps to cleaning and merging the datasets:

+ Step 1: Create a dataframe of country and coach

+ Step 2: For each table in my list, I merge the country and coach columns from Step 1. Note that on the webpage, the data tables are listed in the same order as the list of countries (Italy - Portugal)

+ Step 3: Extract the **age** from the **Date of birth (age)** column and do some final cleaning
